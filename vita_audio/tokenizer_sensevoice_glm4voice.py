...
class SenseVoiceGLM4VoiceTokenizer:
    ...
    def load_model(self,load_flow_trt=False,trt_path=None):
        ...
        model_dir = '/home/fit/renjujty/jty/vita/models/SenseVoiceSmall/'#snapshot_download(repo_id="FunAudioLLM/SenseVoiceSmall")
