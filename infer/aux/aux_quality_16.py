        ...
        for new_text in self.streamer:
            ...
            if "<|end_of_audio|>" == new_text:
                ...
                if 'boost' in model_name_or_path:
                    if num_audio_chunk == 0:
                        pass
                    elif len(audio_tokens) - past_audio_token_len > 24:
                        pass
                    else:
                        continue
                elif 'balance' in model_name_or_path or 'normal' in model_name_or_path:
                    if num_audio_chunk == 0 and len(audio_tokens)==24:
                        pass
                    elif len(audio_tokens) - past_audio_token_len >= 24:
                        pass
                    else:
...
if __name__ == "__main__":
    ...
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/llama_auxq_audio/24/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/llama_auxq_audio/24/"
    ...
    vocoder_time_list = []
    # ====== evaluation loop ======
    for i in range(296,len(audio_path_list)):
        time_list = []
        llm_list = []
        vocoder_list = []
