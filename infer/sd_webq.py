...
if __name__ == "__main__":
    ...
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/webq_SD_audio/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/webq_SD_audio/"
    ...
    vita=VitaPureSpecDecode(draft_model_name_or_path=draft_model_name_or_path,target_model_name_or_path=target_model_name_or_path,device_map=device_map)
    ...
    pre_len=len(num_dict.get("sd_time", []))
    total_time_list = num_dict.get("sd_time", [])
