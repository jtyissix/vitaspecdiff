...
if __name__ == "__main__":
    ...
    time_json_path = "/home/fit/renjujty/WORK/jty/vita/json/b2_8.json"
    # 只保存每个音频第一次生成的文本（jsonl，一行一个json），不存在会自动创建
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/sensitivity/b2/8/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/sensitivity/b2/8/"
    data_csv_path = None
    ...
    pre_len=len(num_dict.get("b2_8_time", []))
    total_time_list = num_dict.get("b2_8_time", [])
    avg_time_list = num_dict.get("b2_8_avg_time", [])
    # ====== evaluation loop ======
    for i in range(pre_len, len(audio_path_list)):
        ...
        num_dict["b2_8_time"] = total_time_list
        num_dict["b2_8_avg_time"] = avg_time_list
