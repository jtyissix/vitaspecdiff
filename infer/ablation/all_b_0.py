...
if __name__ == "__main__":
    ...
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/ablation/allb0/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/ablation/allb0/"
    data_csv_path = None
    ...
    pre_len=len(num_dict.get("allb0_time", []))
    total_time_list = num_dict.get("allb0_time", [])
    avg_time_list = num_dict.get("allb0_avg_time", [])
    # ====== evaluation loop ======
    for i in range(pre_len, len(audio_path_list)):
        ...
        num_dict["allb0_time"] = total_time_list
        num_dict["allb0_avg_time"] = avg_time_list
