            ...
            if "<|end_of_audio|>" == new_text:
                ...
                if 'boost' in model_name_or_path:
                    ...
                    if num_audio_chunk == 0 and len(audio_tokens)==8:
                        ...
                        pass
                    elif num_audio_chunk == 0 and len(audio_tokens)<8:
...
if __name__ == "__main__":
    ...
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/ablation/wospec/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/ablation/wospec/"
    data_csv_path = None
    ...
    pre_len=len(num_dict.get("wospec_time", []))
    total_time_list = num_dict.get("wospec_time", [])
    avg_time_list = num_dict.get("wospec_avg_time", [])
    ...
    for i in range(pre_len, len(audio_path_list)):
        ...
        num_dict["wospec_time"] = total_time_list
        num_dict["wospec_avg_time"] = avg_time_list
