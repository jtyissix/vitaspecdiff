...
if __name__ == "__main__":
    ...
    time_json_path = "/home/fit/renjujty/WORK/jty/vita/json/tqa_sd_1.0.json"
    # 只保存每个音频第一次生成的文本（jsonl，一行一个json），不存在会自动创建
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/sensitivity/SDprob/1.0/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/sensitivity/SDprob/1.0/"
    data_csv_path = None
    ...
    pre_len=len(num_dict.get("alpha_1.0_time", []))
    total_time_list = num_dict.get("alpha_1.0_time", [])
    ...
    for i in range(pre_len, len(audio_path_list)):
        ...
        num_dict["alpha_1.0_time"] = total_time_list
