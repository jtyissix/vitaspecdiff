...
if __name__ == "__main__":
    ...
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/sensitivity/SDprob/0.5/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/sensitivity/SDprob/0.5/"
    data_csv_path = None
    ...
    pre_len=len(num_dict.get("alpha_0.5_time", []))
    total_time_list = num_dict.get("alpha_0.5_time", [])
    ...
    for i in range(pre_len, len(audio_path_list)):
        ...
        num_dict["alpha_0.5_time"] = total_time_list
