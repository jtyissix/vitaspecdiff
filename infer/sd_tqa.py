...
if __name__ == "__main__":
    ...
    text_jsonl_path = "/home/fit/renjujty/WORK/vita_temp/tqa_SD_audio/generated_text.jsonl"
    audio_save_path= "/home/fit/renjujty/WORK/vita_temp/tqa_SD_audio/"
    data_csv_path = None
    os.makedirs(os.path.dirname(text_jsonl_path), exist_ok=True)
    vita=VitaPureSpecDecode(target_model_name_or_path, draft_model_name_or_path, device_map)
