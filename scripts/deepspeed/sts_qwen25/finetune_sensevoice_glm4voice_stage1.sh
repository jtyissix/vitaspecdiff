...
MODEL_NAME_OR_PATH=${ROOT_PATH}/models/Qwen/Qwen2.5-0.5B-Instruct/
...
torchrun $DISTRIBUTED_ARGS tools/finetune_sts_v4_48_3.py \
    ...
    --config_name ${LOCAL_CODE_PATH}/vita_audio/models/qwen2_mtp_sensevoice_v4_48_3/config_7B_mtp0.json \
